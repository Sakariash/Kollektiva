  ...
  return (
    <div className="flex flex-col justify-center content-center bg-primary pb-20">
      <div className="bg-white pt-20 pb-20 mt-20 w-2/3 m-auto rounded-md flex flex-col justify-center content-center">
        ...
        ></img>
        <h1 className="text-5xl font-Poppins m-4 ml-auto mr-auto text-accent text-center w-2/3">
          Tack! Vi har tagit emot din information.
        </h1>
        <p className="text-center font-Inter m-4 ml-auto mr-auto w-2/3">
        ...
        <h2 className="text-xl m-4 font-Inter ml-auto mr-auto text-center w-2/3">
          Du hittar ditt pågående ärende under “Mina sidor”
        </h2>
        <button
          className="bg-btnPrimary font-Poppins p-4 m-2 w-96 rounded-md mr-auto ml-auto"
          href="/mypages"
        >
